...
public class WarehouseAdapter extends RecyclerView.Adapter<WarehouseAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public WarehouseAdapter(Context mContext, ArrayList<HomeModel> mList) {
