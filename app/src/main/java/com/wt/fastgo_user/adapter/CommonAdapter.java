...
public class CommonAdapter extends RecyclerView.Adapter<CommonAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public CommonAdapter(Context mContext, ArrayList<HomeModel> mList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_common, viewGroup, false);
