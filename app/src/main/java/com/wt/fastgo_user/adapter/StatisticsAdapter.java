...
public class StatisticsAdapter extends RecyclerView.Adapter<StatisticsAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public StatisticsAdapter(Context mContext, ArrayList<HomeModel> mList) {
