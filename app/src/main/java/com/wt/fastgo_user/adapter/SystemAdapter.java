...
public class SystemAdapter extends RecyclerView.Adapter<SystemAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public SystemAdapter(Context mContext, ArrayList<HomeModel> mList) {
