...
import com.wt.fastgo_user.adapter.TransferAdapter;
...
public class HaveToFragment extends BaseFragment {

    Unbinder unbinder;
    @BindView(R.id.recycler_transfer)
    RecyclerView recyclerTransfer;
    @BindView(R.id.btn_transfer_merge)
    Button btnTransferMerge;
    private ArrayList<HomeModel> arrayList;
    private TransferAdapter adapter;

    @Override
    protected View getSuccessView() {
        View view = View.inflate(getActivity(), R.layout.fragment_havato, null);
...
//        activity.relativeTop.setVisibility(View.GONE);
    ...
    private void initView() {
        ...
        adapter = new TransferAdapter(getActivity(), arrayList);
