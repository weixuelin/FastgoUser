...
import com.wt.fastgo_user.adapter.TransferListAdapter;
...
//        activity.relativeTop.setVisibility(View.GONE);
    ...
    private void initView() {
        ...
        adapter = new TransferListAdapter(getActivity(), arrayList);
        ...
        adapter.setOnItemClickListener(new TransferListAdapter.OnItemClickListener() {
            @Override
