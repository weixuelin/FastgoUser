...
public class CardFragment extends BaseFragment {
    ...
    @BindView(R.id.linear_card_add)
    LinearLayout linearAddressAdd;
    ...
    protected View getSuccessView() {
        View view = View.inflate(getActivity(), R.layout.fragment_card, null);
    ...
    private void setListener() {
        ...
        linearSettingBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().finish();
            }
        });
        linearAddressAdd.setOnClickListener(this);
    }
