...
import com.wt.fastgo_user.adapter.OrderLibraryAdapter;
...
public class OrderLibraryFragment extends BaseFragment {
    ...
    private OrderLibraryAdapter adapter;
...
//        activity.relativeTop.setVisibility(View.GONE);
    ...
    private void initView() {
        ...
        adapter = new OrderLibraryAdapter(getActivity(), arrayList);
        ...
        adapter.setOnItemClickListener(new OrderLibraryAdapter.OnItemClickListener() {
            @Override
