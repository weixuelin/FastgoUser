...
import com.wt.fastgo_user.adapter.FeedbackAdapter;
...
public class FeedbackPackage extends BaseFragment {
    Unbinder unbinder;
    @BindView(R.id.recycler_feedback)
    RecyclerView recyclerFeedback;
    @BindView(R.id.btn_feedback_add)
    Button btnFeedbackAdd;
    ...
    private void setListener() {
        ...
        recyclerFeedback.setLayoutManager(mLayoutManager);
        ...
        btnFeedbackAdd.setOnClickListener(this);
    }
