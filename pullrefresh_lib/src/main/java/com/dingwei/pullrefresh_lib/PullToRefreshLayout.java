...
//                pullUpView.setVisibility(View.INVISIBLE);
    ...
    /**
     * 设置顶部viewpager滑动事件冲突控制的区域,若不设置就默认全屏
     *
     * @param viewpagerHeight
     */
    public void setAreaHeight(int viewpagerHeight) {
